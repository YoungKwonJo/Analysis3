...
from loadHistograms import loadHistogramMC,loadHistogramDATA,mergesHistograms,mergesHistograms2,mergesHistograms3
...
#  histograms2["ttb"]  = { "h1":mergesHistograms(ttbMerge, histograms),    "FillColor":"#ffcc00", "LineColor":"#000000",  "label":"t#bar{t}bj        "     ,  "label2":"$t\\bar{t}bj$"          }
  ...
  POWttbb = ["POWttbb"]
  POWttjj = ["POWttb","POWtt2b","POWttcc","POWttlf"]
  ttbbUp = mergesHistograms2(POWttbb,histograms,1.16)
  ttbbDown = mergesHistograms2(POWttbb,histograms,0.84)
  ttjjUp = mergesHistograms2(POWttjj,histograms,1.12)
  ttjjDown = mergesHistograms2(POWttjj,histograms,0.88)
  BkgAll = ["POWttot"]+Bkg1
  BkgAllDic = mergesHistograms(BkgAll,  histograms)  
  BkgUp_   = {"ttbb":ttbbUp, "ttjj":ttjjUp,"BkgAll":BkgAllDic } 
  BkgDown_ = {"ttbb":ttbbDown, "ttjj":ttjjDown,"BkgAll":BkgAllDic } 
  BkgUp    = mergesHistograms3(BkgUp_)
  BkgDown  = mergesHistograms3(BkgDown_)
  ...
  sysSet={"bkgSysUp":copy.deepcopy(BkgUp),"bkgSysDown":copy.deepcopy(BkgDown)}
  plotSet = {"ttbars":ttbarlist, "bkg":bkglist, "fullmc":fullmc, "others":others, "mg5":MG5ttbarlist, "labels":statlabels,"sysSet":sysSet}
