...
def fitting(histograms, freeTTB, freeTTCC, GEN, onlyPrint, isPullTest):
  ...
  result3 = {}
  result3["recoR"]=result2["recoR"]
  result3["recoRerror"]=result2["recoRerror"]
  result3["kVal"]=result2["kVal"]
  result3["kValerror"]=result2["kValerror"]
