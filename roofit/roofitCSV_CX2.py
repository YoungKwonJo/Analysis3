...
#  print ttbbCX
  ...
  #k2      = RooFormulaVar("k2","number of tt ot events after fitting","@0/@1",    RooArgList(cxttjj,ttjj_ttbarratio) )
  fsig  =RooFormulaVar("fsig",          "fsig","@0*@1/@2*@3/@4",RooArgList(fsrttbb,effttbb,effttjj,accttbb,accttjj) )

  #k      = RooFormulaVar("k","number of ttjj events after fitting","@0/@1/@2/@3",    RooArgList(cxttjjVS,ttjj_ttbarratio,accttbb,accttjj) )
  ...
  ptBB2 = addLegend2("fit: #sigma_{FS}^{t#bar{t}bb} = "+str(roudV(cenTtbbCX))+" #pm "+str(roudV( errTtbbCX ) ),0.55,0.62)
  ptBB2.Draw()
  ptBB.Draw()
