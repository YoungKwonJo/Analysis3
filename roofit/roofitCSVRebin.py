...
def fitting(histograms, freeTTB, freeTTCC, GEN, onlyPrint, isPullTest):
  ...
  h1_ttbb  = histograms[GEN+"ttbb"]["h1"]
  h1_ttb   = histograms[GEN+"ttb"]["h1"]
  h1_tt2b  = histograms[GEN+"tt2b"]["h1"]
  h1_ttcc  = histograms[GEN+"ttcc"]["h1"]
  h1_ttcclf= histograms[GEN+"ttcclf"]["h1"]
  h1_ttlf  = histograms[GEN+"ttlf"]["h1"]
  h1_ttot  = histograms[GEN+"ttot"]["h1"]
  h1_bkg   = histograms["bkg"]["h1"]
  h1_ddbkg = histograms["ddbkg"]["h1"]
...
######################## 
  if freeTTB and freeTTCC:
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_freeTTBTTCC.eps")
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_freeTTBTTCC.png") 
  elif freeTTB:
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_freeTTB.eps")
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_freeTTB.png")
  elif freeTTCC:              
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_freeTTCC.eps")
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_freeTTCC.png")
  else :                      
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_constraintTTB.eps")
    cR10.Print("test_2dfit_rebin//"+GEN+"_R_constraintTTB.png")
  #return cR10
  ...
  if freeTTB and freeTTCC:
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_freeTTBTTCC.eps")
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_freeTTBTTCC.png") 
  elif freeTTB:
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_freeTTB.eps")
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_freeTTB.png")
  elif freeTTCC:              
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_freeTTCC.eps")
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_freeTTCC.png")
  else :                      
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_constraintTTB.eps")
    cR00.Print("test_2dfit_rebin//"+GEN+"_K_constraintTTB.png")
  ...
  if freeTTB and freeTTCC:
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_freeTTBTTCC.eps")
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_freeTTBTTCC.png") 
  elif freeTTB:
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_freeTTB.eps")
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_freeTTB.png")
  elif freeTTCC:              
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_freeTTCC.eps")
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_freeTTCC.png")
  else :                      
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_constraintTTB.eps")
    cR11.Print("test_2dfit_rebin//"+GEN+"_jet3CSV_constraintTTB.png")
  ...
  if freeTTB and freeTTCC:
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_freeTTBTTCC.eps")
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_freeTTBTTCC.png") 
  elif freeTTB:
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_freeTTB.eps")
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_freeTTB.png")
  elif freeTTCC:
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_freeTTCC.eps")
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_freeTTCC.png")
  else :
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_constraintTTB.eps")
    cR12.Print("test_2dfit_rebin//"+GEN+"_jet4CSV_constraintTTB.png")
  ###########################
  ###########################
  ###########################
  ###########################
  ...
  if freeTTB:  
    ...
    if freeTTCC:
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig2_freeTTBTTCC.eps")
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig2_freeTTBTTCC.png") 
    else :
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig2_freeTTB.eps")
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig2_freeTTB.png")
    ...
    if freeTTCC:
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig3_freeTTBTTCC.eps")
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig3_freeTTBTTCC.png") 
    else :
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig3_freeTTB.eps")
      cNLLContourb.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsig3_freeTTB.png")
  ...
  if freeTTCC:  
    ...
    if freeTTB:
      cNLLContourc.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsigcc_freeTTBTTCC.eps")
      cNLLContourc.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsigcc_freeTTBTTCC.png")
    else :
      cNLLContourc.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsigcc_freeTTCC.eps")
      cNLLContourc.Print("test_2dfit_rebin//"+GEN+"_NLL_fsigVSfsigcc_freeTTCC.png")
  ...
  cN.Print("test_2dfit_rebin//"+GEN+"_Norm1.eps")
  cN.Print("test_2dfit_rebin//"+GEN+"_Norm1.png")
  ###########################
  ...
  cN2.Print("test_2dfit_rebin//"+GEN+"_Norm2.eps")
  cN2.Print("test_2dfit_rebin//"+GEN+"_Norm2.png")
